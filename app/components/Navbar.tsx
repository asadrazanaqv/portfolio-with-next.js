        ...
        <>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justfiy-between h-16">
                  ...
                  <Link
                    ...
                    className={`${
                      pathname === "/"
                        ...
                        : "border-transparent text-gray-500 dark:text-gray-300 hover:text-teal-600  dark:hover:text-teal-600 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    }`}
                  >
                    Home
                  </Link>
              ...
              <div className="-mr-2 flex items-center md:hidden gap-0.5">
                <Themebutton />
